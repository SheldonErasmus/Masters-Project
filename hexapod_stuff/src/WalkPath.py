...
class WalkPath:
    ...
    def footplan(self):
        ...
        dhs = self.Ss/2*(tan(self.p)*cos(self.dir)+tan(self.r)*sin(self.dir))
        dhe = -self.Ss/2*(tan(self.p)*cos(self.dir)+tan(self.r)*sin(self.dir))

        #Start point
        x[0] = self.Rd*cos(self.rot)+(self.Ss/2)*cos(self.dir)
        y[0] = -(self.Rd*sin(self.rot)+(self.Ss/2)*sin(self.dir))
        z[0] = -self.H + dhs
        ...
        #End point
        x[2] = self.Rd*cos(self.rot)-(self.Ss/2)*cos(self.dir)
        y[2] = -(self.Rd*sin(self.rot)-(self.Ss/2)*sin(self.dir))
        z[2] = -self.H + dhe
